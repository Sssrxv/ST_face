...
#include <stdbool.h>
#include <string.h>
#include "../driver/no_os/no_os_defs.h"
#endif // #ifdef DWC_NO_OS
...
static inline const char *dwc_irq(void) {
...
static inline const char *dwc_bh(void) {
	return DWC_IN_BH() ? "BH" : "";
}
...
//#ifdef DWC_LINUX
#if defined (DWC_LINUX) || defined (DWC_NO_OS)
...
#define dwc_schedule_system_work DWC_SCHEDULE_SYSTEM_WORK
/** Schedule a work on the system workq  */
extern bool DWC_SCHEDULE_SYSTEM_WORK(struct work_struct *work);
...
#ifdef DWC_NO_OS
/** Type for a spinlock */
typedef uint32_t dwc_spinlock_t;
#endif
