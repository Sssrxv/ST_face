...
public:
    ...
    virtual int get_workpingbuffer_size(void) = 0;
    virtual int get_workpongbuffer_size(void) = 0;
    virtual int set_workbuffer(uint32_t addr, int size) = 0;
    virtual int set_workpingbuffer(uint32_t addr, int size) = 0;
    virtual int set_workpongbuffer(uint32_t addr, int size) = 0;
