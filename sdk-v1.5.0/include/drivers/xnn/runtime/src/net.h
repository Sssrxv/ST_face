...
#define XNN_MAX_CNV_IC          (1024)
#define XNN_MAX_CNV_OC          (1024)
...
public:
    ...
    int get_input_blob_top_input_channel(int &channel);
...
public:
    ...
    // NOTE: used hack early release memory
    std::vector<Mat>& get_blob_mats()
    {
        return blob_mats;
    }
