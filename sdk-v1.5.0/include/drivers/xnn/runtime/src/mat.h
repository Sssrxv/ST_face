...
int chw2hwc_float32_to_int8_with_float16_multiply(const xnn::Mat &src, void* dst_data, int cn, float scale, float mean, float norm);
...
int rgba2hwc_uint8_to_int8(const xnn::Mat &blob_in, xnn::Mat &blob_out, float scale_to_int8, float mean, float norm);
int gray2hwc_uint8_to_int8(const xnn::Mat &blob_in, xnn::Mat &blob_out, float scale_to_int8, float mean, float norm);
