...
#define XNN_LOGE(expr ...)  xnn_log_printf(XNN_LOG_ERROR,   __FILENAME__, __LINE__, __func__, expr)
#define XNN_LOGW(expr ...)  xnn_log_printf(XNN_LOG_WARN,    __FILENAME__, __LINE__, __func__, expr)
#define XNN_LOGI(expr ...)  xnn_log_printf(XNN_LOG_INFO,    __FILENAME__, __LINE__, __func__, expr)
#define XNN_LOGD(expr ...)  xnn_log_printf(XNN_LOG_DEBUG,   __FILENAME__, __LINE__, __func__, expr)
#define XNN_LOGV(expr ...)  xnn_log_printf(XNN_LOG_VERBOSE, __FILENAME__, __LINE__, __func__, expr)
#else
