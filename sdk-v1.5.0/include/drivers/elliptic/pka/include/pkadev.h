...
#define USE_WORKAROUND_MODEXP 1
 ...
 */
int elppka_set_operand(const char *func, const char *name,
                               unsigned size, const void *data);
int elppka_get_operand(const char *func, const char *name,
 ...
 * on failure.
 */
int elppka_copy_operand(const char *dst_func, const char *dst_name,
 ...
 * on error.
 */
int elppka_test_flag(const char *func, const char *name);
 ...
 */
int elppka_set_flag(const char *func, const char *name);
...
int elppka_run(const char *func, unsigned size, ...);

/*
 * Close a previously opened PKA character device.
 */
int elppka_device_close();
