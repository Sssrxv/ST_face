...
#ifndef CONFIG_DDR_SIZE_KB
#error Should define CONFIG_DDR_SIZE_KB
#endif
#define __DDR_SIZE                              (CONFIG_DDR_SIZE_KB * 1024 - __DMA_MEM_SIZE)
...
#define __FW_SPACE_SIZE                         (CONFIG_FW_SPACE_SIZE_KB * 1024)
#   define __FW_CODE_SIZE                       (CONFIG_FW_CODE_SIZE_KB  * 1024)
#   define __HEAP_SIZE                          (CONFIG_FW_HEAP_SIZE_KB  * 1024)
#   define __STACK_SIZE                         (__FW_SPACE_SIZE - __FW_CODE_SIZE - __HEAP_SIZE)  /*8MB*/

#define __DMA_MEM_BASE                          (__DDR_BASE + __DDR_SIZE)
#   define __DMA_MEM_SIZE                       ((CONFIG_DDR_SIZE_KB - CONFIG_FW_SPACE_SIZE_KB) * 1024)
...
#if !(FW_MEM_ASSERT)
#error wrong mem map FW_MEM_ASSERT
#endif
#if !(DDR_MEM_ASSERT)
#error wrong mem map DDR_MEM_ASSERT
#endif
