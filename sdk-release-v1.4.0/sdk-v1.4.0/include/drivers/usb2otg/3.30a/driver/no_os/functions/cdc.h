// port from linux kernel: https://elixir.bootlin.com/linux/v4.8/source/include/uapi/linux/usb/cdc.h
// modified some data type
// __u8    -> uByte
// __le16  -> uWord
// __le_32 -> uDWord
// __u16   -> uWord
...
#ifndef __UAPI_USB_CDC_H
#define __UAPI_USB_CDC_H
...
typedef struct usb_cdc_union_desc {
	...
	uByte	bMasterInterface0;
	uByte	bSlaveInterface0;
...
struct usb_cdc_mbim_extended_desc {
	...
	uWord	bcdMBIMExtendedVersion;
	uByte	bMaxOutstandingCommandMessages;
	uWord	wMTU;
} __attribute__ ((packed));
...
struct usb_cdc_speed_change {
	uDWord	DLBitRRate;	/* contains the downlink bit rate (IN pipe) */
	uDWord	ULBitRate;	/* contains the uplink bit rate (OUT pipe) */
} __attribute__ ((packed));
